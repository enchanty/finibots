//api keyi değiştirmezseniz iyi olur... ama değiştirebilirsiniz (Ses bozuksa değiştirmeyi deneyin )
...
client.on('message', async msg => {
	...
	} else if (command === 'skip' || command === "geç" || command === "skip") {
	...
	} else if (command === 'ses' || command === "volume") 
  {
   ...
   .setTitle(`:warning: Şuanki Ses Seviyesi: **${serverQueue.volume}**`)
    ...
    .setColor('#FF0000'));     
      ...
      {
        return msg.channel.send(':warning: | **Yetkiniz Yetersiz**');
      }
...
client.on("ready", () => {
  //client.channels.get("695694321432657960").join();
